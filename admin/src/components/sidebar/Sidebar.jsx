...
import "./Sidebar.scss";
import { Home, BarChart, TrendingUp, People, Person, LocalMovies, Movie, List, Mail, DynamicFeed, Chat, BusinessCenter, Report, AssignmentAdd } from "@mui/icons-material";
        ...
        <div className="menu-container">
          ...
          <div className="menu-block">
            ...
            <ul className="block-selection">
              ...
              <Link to="/newlist" className="link"><li className="block-item"><AssignmentAdd className="icon" />Log List</li></Link>
            </ul>
          </div>
